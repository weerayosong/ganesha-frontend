...
export default function FloatingMenu() {
    return (
        ...
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 md:bottom-8 md:right-8 md:left-auto md:translate-x-0 z-50 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Link
                href="/shelf"
