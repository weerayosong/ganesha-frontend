    ...
    return (
        <div className="w-full max-w-2xl mx-auto mt-6 lg:mt-auto flex items-center justify-between lg:justify-start lg:gap-8 pt-4 lg:pt-8 pb-2 lg:pb-0 border-t border-amber-900/20 lg:border-t-0">
            ...
            <button
                ...
                // disabled={true} // ไว้ปลดล็อกตอนต่อ State
            >
                <FaChevronLeft className="w-5 h-5 pr-1" />
            </button>

            {/* ตัวเลขบอกลำดับ (Counter) */}
            ...
            {/* ปุ่มถัดไป (Next) */}
            <button className="w-12 h-12 lg:w-14 lg:h-14 rounded-full border border-amber-700/40 flex items-center justify-center text-amber-500 hover:bg-amber-700/20 transition-all cursor-pointer disabled:opacity-20 disabled:cursor-not-allowed">
